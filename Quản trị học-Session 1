Task 1: Phân tích và Vận dụng Mô hình P.O.L.C
...
​Tỷ trọng kỹ năng của CEO (Cấp cao):

​Kỹ năng Nhận thức/Tư duy (Conceptual skills): Chiếm tỷ trọng cao nhất (~50%). CEO cần khả năng nhìn bao quát toàn bộ hệ thống, nhận diện cơ hội và thách thức và ngoài ra phải hoạch định chiến lược dài hạn đưa công ty thoát khỏi khủng hoảng.
    
​Kỹ năng Nhân sự (Human skills): Chiếm tỷ trọng lớn (~40%). Cần thiết để giao tiếp, truyền cảm hứng, giải quyết mâu thuẫn và kết nối các cấp quản lý.
    
​Kỹ năng Chuyên môn/Kỹ thuật (Technical skills): Chiếm tỷ trọng nhỏ nhất (~10%). CEO chỉ cần hiểu nguyên lý vận hành chung, không cần đi sâu vào thao tác kỹ thuật chi tiết của từng máy móc hay phần mềm.
...
​Bộ phận kho và logistics hoàn thành mục tiêu giao 1.000 đơn hàng đến tay người tiêu dùng trong ngày theo đúng cam kết (đạt Hiệu quả – Làm đúng việc). Tuy nhiên, do điều phối tuyến đường kém, họ phải thuê thêm nhiều xe ngoài chạy khẩn cấp và nhân viên tăng ca đêm, khiến chi phí vận chuyển tăng gấp đôi ngân sách định mức (thiếu Hiệu suất – Lãng phí nguồn lực).

​Hành động cải thiện của CEO:
​Ứng dụng phần mềm tối ưu hóa lộ trình giao hàng (Route Optimization) và thiết lập quy trình gom đơn thông minh và đồng thời bổ sung chỉ số "Chi phí vận chuyển trên mỗi đơn hàng" vào KPI của bộ phận giao vận để vừa đạt mục tiêu thời gian vừa giữ chi phí ở mức tối ưu.
